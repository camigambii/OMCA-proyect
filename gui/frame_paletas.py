...
class FramePaletas(ctk.CTkFrame):
    ...
    def _construir(self):
        ctk.CTkLabel(
            self,
            text="P A L E T A S  D E  S O M B R A S",
        ...
        ctk.CTkLabel(
            self,
            text="Combina tonos y crea looks increíbles",
            font=("Arimo", 12),
            text_color="#888888"
        ).pack(pady=(0, 14))
        ...
        self.entry_buscar = ctk.CTkEntry(
            barra,
            placeholder_text="🔍  Buscar paleta...",
            font=("Arimo", 13),
            width=240,
            height=36,
            corner_radius=18,
    ...
    def _poblar_catalogo(self, productos: list):
        ...
        if not productos:
            ctk.CTkLabel(
                self.panel_catalogo,
                text="No hay paletas en esta categoría.",
                font=("Arimo", 14),
                text_color="#AAAAAA"
