...
class FrameRubor(ctk.CTkFrame):
    def __init__(self, parent, app):
        ...
        for p in inventario_completo:
            ...
            if "rubor" in cat_limpia or "blush" in cat_limpia:
    ...
    def _construir(self):
        ctk.CTkLabel(
            self,
            text="R U B O R  E N  C R E M A  Y  P O L V O",
        ...
        ctk.CTkLabel(
            self,
            text="Dale vida y color natural a tus mejillas",
            font=("Arimo", 12),
            text_color="#888888"
        ).pack(pady=(0, 14))
    ...
    def _poblar_catalogo(self, productos: list):
        ...
        if not productos:
            ctk.CTkLabel(
                self.panel_catalogo,
                text="No hay rubores en esta categoría.",
                font=("Arimo", 14),
                text_color="#AAAAAA"
